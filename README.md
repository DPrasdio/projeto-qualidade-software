...
## Entrega 3 — PBL 9 a 12 (Processo, Maturidade, Ágil e CI)

A terceira entrega desloca o foco do produto para o **processo** de desenvolvimento da equipe.

| PBL | Tema | Link |
|---|---|---|
| PBL9 | Qualidade de Processo | [Ver](PBL9/README.md) |
| PBL10 | Modelos de Maturidade | [Ver](PBL10/README.md) |
| PBL11 | Qualidade em Metodologias Ágeis | [Ver](PBL11/README.md) |
| PBL12 | Integração Contínua, Qualidade Automatizada, Métricas e Gestão de Defeitos | [Ver](PBL12/README.md) |

O PBL12 inclui um laboratório funcional (`PBL12/`) com testes unitários e BDD em Python + pipeline de GitHub Actions, cobrindo o bug de persistência de favoritos identificado no PBL5.
